  ...
  return (
    <div>
      ...
      <div className="bg-lightgray p-5 rounded-[18px]">
          <h5 className="font-semibold text-base md:text-lg text-white text-center mb-6">Trade Summary</h5>
          ...
          <div className="bg-linear-to-b from-lightgray to-[#393939] p-4 rounded-[18px] border border-[#404040] mt-6 flex flex-col md:flex-row items-center justify-between gap-6 lg:gap-0">
            {/* Trade Card 1 */}
              ...
              <div className="flex-1 w-full md:w-auto text-center md:text-left">
                ...
                <p className="text-gray text-xs md:text-sm mb-3">WR 1 - BAL 156pts</p>
                <p className="text-[#FABA17] text-xs md:text-sm font-semibold">1st Round - Pick 14</p>
              </div>
...
export default DraftTradeZoneSecond
