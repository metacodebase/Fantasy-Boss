         ...
         <Row gutter={[
                ...
                <div className="bg-lightgray rounded-[18px] p-5 h-full">
                    ...
                    <div className="flex items-center gap-2">
                        <button className="yellow-button h-8 text-sm! px-4!">use defaults</button>
                        <button className="yellow-outline-button h-8 text-sm! px-4!">Edit settings</button>
                    </div>
