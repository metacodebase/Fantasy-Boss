...
const KeeperSettings = () => {
  return (
    ...
    <div className="bg-lightgray p-5 rounded-[18px]">
            <h4 className="font-semibold text-2xl mb-4 text-white">Keeper Settings Configuration</h4>
      ...
      Allow Contract Extensions?
        ...
        <div className="border-b border-[rgba(255,255,255,0.24)] pb-6 mt-4">
           ...
           <div className="h-12 w-[102px] border border-yellow rounded-md flex items-center justify-center">
             1
           </div>
           </div>
        ...
        <div className="border-b border-[rgba(255,255,255,0.24)] pb-6 mt-4">
          <div className="font-semibold text-lg mb-3">
            Date Keepers to be declared by
              ...
              <button className="bg-[#050608] rounded-md border w-full md:w-xl h-[74px]  border-yellow flex items-center px-4 text-white gap-4">
        ...
        <div className="border-b border-[rgba(255,255,255,0.24)] pb-6 mt-4">
            ...
            <div className="flex items-center gap-2">
                <button className="bg-linear-to-b from-[#FAAC15] to-[#F9D81B] px-4 h-10 w-[128px] rounded-full text-base! text-black font-semibold">Yes</button>
                <button className="border border-yellow-500 px-4 h-10 w-[128px] rounded-full text-base! font-semibold">No</button>
